        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="relative">
                <input
                    v-model="searchQuery"
                    type="text"
                    class="w-64 p-3 rounded-full shadow-sm focus:border "
        ...
        <div class="grid grid-cols-12 gap-8">
            <div class="col-span-3">
                <div class="bg-orange p-6 rounded-lg shadow-md">
                    ...
                    <div class="mt-4 flex">
                        ...
                        <button class="ml-4 bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">
                            Add
                        </button>
                    </div>
            ...
            <div class="col-span-9">
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div
                        class="bg-gray-100 rounded-lg flex justify-center items-center h-72 shadow-md cursor-pointer hover:bg-gray-200"
                    >
