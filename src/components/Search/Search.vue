...
<template>
    <div class="min-h-screen bg-primary p-6">
        ...
        <div class="flex justify-between items-center mb-6 w-full">
            ...
            <button class="bg-light_blue text-white py-1 pl-3  rounded-2xl hover:bg-dark_blue">
                Create <i class=" m-2 fa-solid fa-circle-plus "></i>
            </button>
        </div>
        ...
        <div class="mb-8 flex justify-center">
            ...
            />
            <button
                class="ml-4 bg-light_blue text-white px-6 py-3 rounded-2xl hover:bg-dark_blue"
                @click="searchGroups"
            >
                Search Group
            </button>
